...
export default {
  entities: {
    ...
    posts: {
      allIds: new Array(10).fill(0).map((d, i) => `post-00${i}`),
      byId: {
        'post-000': {
          id: 'post-000',
          user: 'user-001',
        ...
        'post-005': {
          ...
          user: 'user-003',
          images: [
            { id: 'i-001', url: process.env.PUBLIC_URL + '/assets/tmp-img-3.jpg', w: 1400, h: 100 }
          ],
        ...
        'post-006': {
          ...
          content: "我没开出门啊，大哥！",
          images: [
            { id: 'i-001', url: process.env.PUBLIC_URL + '/assets/tmp-img-4.jpg', w: 100, h: 1400 }
          ],
        ...
        'post-008': {
          ...
          user: 'user-004',
          images: [
            { id: 'i-001', url: process.env.PUBLIC_URL + '/assets/tmp-img-6.jpg', w: 30, h: 720 }
          ],
